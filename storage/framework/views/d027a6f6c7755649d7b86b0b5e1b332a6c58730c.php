...
<section class="chheckout-section" style="margin-top: 50px;">
    <?php
    ...
    ?>
    <div class="container" id="chheckout-section-downwork">
        <div class="row">
...
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\shop\resources\views/frontEnd/layouts/customer/checkout.blade.php ENDPATH**/ ?>