...
@push('css')
    ...
    <style>
    .card-title{display:-webkit-box;-webkit-line-clamp:1;-webkit-box-orient:vertical;overflow:hidden;text-overflow:ellipsis}
    </style>
@endpush
@push('seo')
...
@section('content')
    <section class="product-section">
        <div class="container" id="sorting-section-down-more">
            <div class="sorting-section" style="margin-top: 20px;">
                <div class="row">
                    <div class="col-sm-6">
                            ...
                            <div class="product-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        @else
                                        <div class="cart_btn order_button" style="height: 38px;">
