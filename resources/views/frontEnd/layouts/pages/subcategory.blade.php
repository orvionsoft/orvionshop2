...
<style>
.product-card .card-title{display:-webkit-box;-webkit-line-clamp:1;-webkit-box-orient:vertical;overflow:hidden;text-overflow:ellipsis}
</style>
@endpush 
@push('seo')
...
@endpush 
@section('content')
<section class="product-section" style="margin-top: -130px">
    <div class="container" id="sorting-section-down">
        <div class="sorting-section" style="margin-top: 180px !important;" >
            <div class="row">
                <div class="col-sm-6">
                            ...
                            <div class="product-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        @else
                                        <div class="cart_btn order_button">
                                            <a class="addcartbutton order-btn" style="height: 38px !important;" data-id="{{ $value->id }}" data-checkout="yes">
                                                <span>অর্ডার করুন</span>
                                            </a>
                                        </div>
                                        @endif
