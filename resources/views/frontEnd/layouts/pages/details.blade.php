                       ...
                       <div class="wist_item wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.{{ $key }}s">
                            <div class="product-card">
                                ...
                                <div class="discount-badge">
                                    {{ number_format($discount, 0) }}%<br>ছাড়
                                </div>
                                @endif
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        @else
                                        <div class="cart_btn order_button">
                                            <a style="height: 38px !important;" class="addcartbutton order-btn" data-id="{{ $value->id }}" data-checkout="yes">
                                                <span style="padding-top: 2px;">অর্ডার করুন</span>
                                            </a>
                                        </div>
                                        @endif
                                    </div>
